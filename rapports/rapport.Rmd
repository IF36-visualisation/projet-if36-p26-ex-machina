...
Nos données vont de mars à mai 2026.
...
Nous nous intéressons à la qualité nutritionnelle de l'offre de restauration collective CROUS. 
...
- Les options "plaisir" : Les burgers, pizzas et surtout les viennoiseries s'élèvent vers les scores 4 (D) et 5 (E), ce qui confirme notre hypothèse initiale sur la qualité nutritionnelle de l'offre snacking.
...
![Répartition globale des Nutri-Scores](images/repeGlobale.png)
...
![Répartition des Nutri-Scores par catégorie de plat](images/prop.png)
